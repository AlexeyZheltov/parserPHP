...
<p>Процесс сканирования <b><?php echo $row[0]; ?></b> сайтов остановлен пользователем.</p>
<p>Для запуска этих сайтов зайдите в их настройки и установите значение "Остановка" равной 0.</p>

<p><a href="?site_go_all=1">ОТМЕНИТЬ ОСТАНОВКУ ДЛЯ ВСЕХ САЙТОВ</a></p>
<table  border="1">
  <tr>
    <th>ID</th>
    <th>Наименование</th>
...
<?php for ($i = 0; $i < count($site_array); $i++) { ?>
  <tr
   ...
   // если заблокирован
    ...
    <td>
      <?php         echo '<a href="?site_go=' . $site_array[$i]['id_site'] . '">Отменить остановку</a>';
       ?>
    </td>
     <td>
...
<p>Отсутствуют сайты, остановленные пользователем</p>
<?php } ?>
</div> <!-- End story -->
<div id="sidebar">
