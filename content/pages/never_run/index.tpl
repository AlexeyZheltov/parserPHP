...
<p>Количество неотсканированных ни разу сайтов: <b><?php echo count($site_array); ?></b>.</p>


<p><a href="?id_site=all">ЗАПУСК ВСЕХ НЕ ОТСКАНИРОВАННЫХ НИ РАЗУ САЙТОВ</a></p>
<table  border="1">
  <tr>
    <th>ID</th>
    <th>Наименование</th>
...
<p>У вас не осталось не отсканированных сайтов</p>
<?php } ?>
</div> <!-- End story -->
<div id="sidebar">
